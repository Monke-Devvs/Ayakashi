...
import Ayakashi.helpers.GuiLicenseHelper;
import Ayakashi.helpers.MainMenuHelper;
import Ayakashi.helpers.PacketHelper;
import Ayakashi.helpers.UserNameApi;
...
import xyz.szymeko.packet.AddUserPacket;
import xyz.szymeko.packet.ChatPacket;
import xyz.szymeko.packet.OnlineUsersPacket;
import xyz.szymeko.packet.RemoveUserPacket;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        try {
            ...
            try {
                ...
                File f3 = new File("SzymekoMujKrul/NoxerekKrul.txt");
                if (!f.exists()) {
                    f.mkdir();
                }
                if (!f2.exists()) {
        ...
        getMinecraft().displayGuiScreen(new GuiLicenseHelper());
    }
    ...
    public void shutdown() {
        //Ayakashi.nettyServer.getChannel().writeAndFlush(new RemoveUserPacket(this.session.getUsername()));
