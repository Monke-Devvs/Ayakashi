...
public final class ItemStack {
    ...
    public static boolean areItemsEqual(ItemStack stackA, ItemStack stackB) {
        if (stackA == null && stackB == null) {
            ...
            return stackA != null && stackA.isItemEqual(stackB);
        }
    }
    ...
    public ItemStack setStackDisplayLore(String Lores) {
        setStackDisplayLore(new String[]{Lores});
        return this;
    }

    public void setStackDisplayLore(String[] Lores) {
        if (this.stackTagCompound == null)
            this.stackTagCompound = new NBTTagCompound();
        if (!this.stackTagCompound.hasKey("display", 10))
            this.stackTagCompound.setTag("display", new NBTTagCompound());
                ...
                if (nbttaglist != null) {
                    for (int j = 0; j < nbttaglist.tagCount(); ++j) {
                        ...
                        if (Enchantment.getEnchantmentById(k) != null) {
                            assert Enchantment.getEnchantmentById(k) != null;
